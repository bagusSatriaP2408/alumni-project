...
<div class="container mx-auto px-4 ">
    ...
    <h1 class="text-3xl font-semibold mb-4 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">Kuisioner Alumni</h1>
                    ...
                    <tbody class="text-center">
                        @foreach ($main_kuisioner as $m)
                            <tr class="border-b">
                                ...
                                <td class="py-2 px-4">
                                    <a href="{{ route('admin.kuisioner.output', ['id' => $m->id_main_kuisioner]) }}" class="inline-flex items-center justify-center bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded transition duration-150 ease-in-out">Opsi</a>
    ...
    <h1 class="text-3xl font-semibold mb-4 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">Kuisioner Vendor</h1>
