    ...
    <div class="bg-white py-8">
        <div class="container mx-auto px-4 flex flex-col md:flex-row">
            <div class="w-full md:w-3/4 px-4">
                <h1 class="text-3xl font-bold mb-6">Selamat Datang di Portal Alumni Kami</h1>
            ...
            <div class="w-full md:w-1/4 px-4 mt-8 md:mt-0">
                <div class="bg-gray-100 p-6 rounded-lg shadow-lg">
                    ...
                    <ul class="list-none">
                        <li class="mb-2">
                            <a href="#" class="text-gray-700 hover:text-gray-900">2020</a>
                        </li>
                        <li class="mb-2">
                            <a href="#" class="text-gray-700 hover:text-gray-900">2021</a>
                        </li>
                        <li class="mb-2">
                            <a href="#" class="text-gray-700 hover:text-gray-900">2022</a>
                        </li>
                        <li class="mb-2">
